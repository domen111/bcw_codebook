...
\usepackage{amsmath, courier, listings, fancyhdr, graphicx, tikz}
\topmargin=0pt
\headsep=5pt
\textheight=780pt
\footskip=0pt
...
\setCJKmainfont{Noto Sans CJK TC}			%中文字型
...
\lstdefinelanguage{vim}{
  % list of keywords
  morekeywords={set, let, map, nmap, filetype, on, off, autocmd, call, colorscheme},
  morecomment=[f]{"}, % l is for line comment
...
\fancyhead[L]{National Taiwan University: lite}
\fancyhead[R]{\thepage}
...
\section{Basic}
\subsection{vimrc}
\lstinputlisting[language=vim]{../codes/Basic/vimrc}
...
\subsection{Kuhn Munkres - $O(n^3)$}
\lstinputlisting{"../codes/Graph/Matching/Kuhn_Munkres - sunmoon.cpp"}
...
\lstinputlisting{../codes/Graph/Matching/general_graph_matching_wangyenjen.cpp}
...
\lstinputlisting{../codes/Math/prime.sh}
...
\lstinputlisting{../codes/Geometry/Half_plane_intersection/half_plane_intersection_wangyenjen.cpp}
...
\section{Other}
\subsection{\_\_builtin\_}
\lstinputlisting{../codes/Other/__builtin_.cpp}

\subsection{bitwise operations - collection}
\lstinputlisting{"../codes/Other/bitwise operations - collection.cpp"}

\subsection{Increase Stack}
\lstinputlisting{../codes/Other/IncStack.cpp}

\subsection{GCC Pragma}
\lstinputlisting{../codes/Other/pragma.cpp}

%\section{Graph paper}
%\begin{tikzpicture}[x=1cm, y=2cm, semitransparent]
